...
if(isset($_POST['submit']))
{
	...
	$isofficer=1;
	$query=mysqli_query($bd, "insert into officers(fullName,username,password,isOfficer) values('$fullname','$username','$password','$isofficer')");
}
...
<head>
	...
	<title>Admin | Create Officer</title>
...
{?>
									...
									<strong>Well done! Registration successfull!!!</strong>	<?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?>
									</div>
<?php } ?>
