...
if(isset($_POST['submit']))
{
    ...
    $_SESSION['msg']="Barangay $state added successfully !!";
}

if(isset($_GET['del']))
		  {
		          mysqli_query($bd, "delete from state where id = '".$_GET['id']."'");
                  $_SESSION['delmsg']="Barangay deleted !!";
		  }
...
<label class="control-label" for="basicinput">Barangay Name</label>
<div class="controls">
<input type="text" placeholder="Enter Barangay Name" name="state" class="span8 tip" required>
</div>
</div>
