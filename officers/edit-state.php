...
if(isset($_POST['submit']))
{
    ...
    $_SESSION['msg']="Barangay $state Updated !!";
...
<div class="controls">
<input type="text" placeholder="Enter Barangay Name"  name="state" value="<?php echo  htmlentities($row['stateName']);?>" class="span8 tip" required>
</div>
</div>
