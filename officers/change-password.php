...
{
$sql=mysqli_query($bd, "SELECT password FROM  officers where password='".md5($_POST['password'])."' && username='".$_SESSION['ologin']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($bd, "update officers set password='".md5($_POST['newpassword'])."', updationDate='$currentTime' where username='".$_SESSION['ologin']."'");
