...
<label class="col-sm-2 col-sm-2 control-label"><b>Barangay :</b></label>
              <div class="col-sm-4">
...
<label class="col-sm-2 col-sm-2 control-label"><b>Proof of work:</b></label>
              <div class="col-sm-10">
              	<p><?php $cfile=$rw['prooffile'];
if($cfile=="" || $cfile=="NULL")
{
  echo htmlentities("File NA");
}
