...
$complainno=$cmpn;
 $successmsg = 'Your complain has been successfully filed and your complaint number is '.$complainno.', you can also check the status of your complain in your complaint history.';
}
else
{
 $errormsg = 'Uploaded file is not an image, please try again!';
}
}
?>
...
<label class="col-sm-2 col-sm-2 control-label">Barangay</label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Complaint Proof (Take a picture)</label>
<div class="col-sm-6">
<img id="imagepreview" src="" alt="File Not Supported" />
