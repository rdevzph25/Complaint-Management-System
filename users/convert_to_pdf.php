<?php
session_start();
require('../admin/libs/html2pdf.php');
...
function Footer()
{
    ...
    // Page number
    $this->Cell(0,10,'This document was auto generated from DPWH | CMS Sablayan website.',0,0,'C');
}
}
...
<b>Complaint Details:</b> $details";
	...
	if ($prooffile == "" || $prooffile == "NULL"){
		...
		$pdf-> Text(12,200,'Proof of work submitted and was closed on '.$new_closed_date.'');
